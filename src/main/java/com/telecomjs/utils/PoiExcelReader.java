...
public class PoiExcelReader implements Iterable<String[]> {
    ...
    private short fileType; //defalult xls
    //Iterator 使用的对象
    ...
    public PoiExcelReader(InputStream is){
        this(is,true,null,(short)0);
    }

    public PoiExcelReader(InputStream is,short type){
        this(is,true,null,type);
    }

    public PoiExcelReader(InputStream is,String sheetName){
        this(is,true,sheetName,(short)0);
    }
     ...
     */
    public PoiExcelReader(InputStream is ,boolean hasTitle ,String sheetName,short type ){
        this.inputStream = is;
    ...
    public void open(){
        try {
            ...
            e.printStackTrace();
            throw  new UnsupportedOperationException("不支持当前文件类型!");
        }
    }
