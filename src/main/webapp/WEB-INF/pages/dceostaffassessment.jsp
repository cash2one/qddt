...
<div class="container" >
    ...
    <div class="panel panel-default">
        ...
        <form action="/assessment/dceostaffassessment.html" type="GET">
        ...
        <div><h6></h6></div>
        <!-- Table -->
        <table  id="dg" class="easyui-datagrid" title="分局考核清单" style="width:100%;height:400px"
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'criterion',width:100,sorter:numberSort">考核标准</th>
                    <th data-options="field:'score',width:100,sortable:true,sorter:numberSort,sorter:numberSort">考核得分</th>
