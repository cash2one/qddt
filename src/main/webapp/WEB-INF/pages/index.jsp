					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 考核管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
						 ...
						 <%--<li class="home"><a href="javascript:void(0)" name="模板维护.html" title="模板维护"  class="iframeurl"><i class="icon-double-angle-right"></i>审批考核分配表</a></li>--%>
                         </ul>
					</li>

						<li>
					<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 报表管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                    ...
                    <li class="home"><a href="javascript:void(0)" name="/assessment/adminstaffassessment.html?cycle=0" title="绩效视图"  class="iframeurl"><i class="icon-double-angle-right"></i>绩效视图</a></li>
						...
						<li><a href="#" class="dropdown-toggle"><i class="icon-edit"></i><span class="menu-text"> 系统管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <!--结束-->
                                <li class="home"><a href="javascript:void(0)" name="/item/modifyassessmentgroup.html" title="管理考核项组" class="iframeurl"><i class="icon-double-angle-right"></i>管理考核项组</a></li>
                                <li class="home"><a href="javascript:void(0)" name="/item/modifyassessmentitem.html?role=CEO" title="管理打分模板" class="iframeurl"><i class="icon-double-angle-right"></i>管理考核模板</a></li>
...
<!-- /.page-content -->
         ...
         <!--修改密码样式-->
         <div class="change_Pass_style" id="change_Pass" style="height: 200px;">
            <ul class="xg_style">
